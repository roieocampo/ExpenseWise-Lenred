-- ExpenseWise Lenred schema for a SHARED Supabase project (e.g. SLIC_DashBoards)
...
DO $$ BEGIN CREATE POLICY expense_categories_read_access ON public.expense_categories FOR SELECT TO authenticated USING(public.expense_can_view_category(id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY expense_budgets_read ON public.expense_weekly_budgets FOR SELECT TO authenticated USING(public.expense_can_view_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY expense_budgets_update ON public.expense_weekly_budgets FOR UPDATE TO authenticated USING(public.expense_can_edit_category(category_id)) WITH CHECK(public.expense_can_access_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY expense_budgets_delete ON public.expense_weekly_budgets FOR DELETE TO authenticated USING(public.expense_can_edit_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY expense_sections_read ON public.expense_list_sections FOR SELECT TO authenticated USING(public.expense_can_view_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY expense_sections_update ON public.expense_list_sections FOR UPDATE TO authenticated USING(public.expense_can_edit_category(category_id)) WITH CHECK(public.expense_can_access_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY expense_sections_delete ON public.expense_list_sections FOR DELETE TO authenticated USING(public.expense_can_edit_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY expense_items_read ON public.expense_items FOR SELECT TO authenticated USING(public.expense_can_view_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY expense_items_update ON public.expense_items FOR UPDATE TO authenticated USING(public.expense_can_edit_category(category_id)) WITH CHECK(public.expense_can_access_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY expense_items_delete ON public.expense_items FOR DELETE TO authenticated USING(public.expense_can_edit_category(category_id)); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
